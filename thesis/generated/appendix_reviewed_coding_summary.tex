...
\caption[Reviewed API/app coding summary for all 60 prompts]{Reviewed API/app coding summary for all 60 paired prompts. The table reports final claim safe labels only, not raw high risk prompt or output text.}\\
\toprule
