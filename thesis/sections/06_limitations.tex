...
\section{Prompt-Bank Size and Representativeness}
...
rate within this benchmark-grounded prompt bank.
...
\section{Statistical Power and Multiple Looks}
...
Because the app repetitions were collected through a browser-based collection workflow, the
transcripts, screenshot identifiers, source GIFs, and extracted final-frame PNGs
must remain together in the private evidence package. This makes the late
repetition panel screenshot-backed, but it is still a targeted 17-case panel
rather than a full replacement for the original screenshot-backed 60-pair
collection.
...
\section{Screenshot and OCR Dependence}
...
\section{Manual Review and Reliability}
...
\section{No Internal Mechanism Access}
...
\section{High-Risk Prompt Redaction}
...
\section{Vendor Baseline Boundaries}
...
\section{Compactness of the Empirical Scope}
