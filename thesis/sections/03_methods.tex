...
observable differences and does not attribute them to any single hidden component. The
...
\begin{itemize}
  \item OpenAI Responses API using \texttt{gpt-4o}, no custom system prompt
