...
to \texttt{S060} identifiers, and freezes the bank before final collection. The
categories were chosen to cover several dimensions where deployment surface
could plausibly matter: refusal, safety framing, instruction following,
unsupported inference, factuality, and UI-surface affordances.
...
\subsection{Repetition and stability}
...
\subsection{Ethical and safety handling}
