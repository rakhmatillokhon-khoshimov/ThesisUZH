...
\small Thesis draft compiles at \textbf{83 pages}: all chapters written, 4 figures, 25 tables, 81 metadata-verified references, all numbers auto-generated from the pipeline.
\end{block}
\end{column}
\end{columns}
\vspace{0.2cm}
