...
\small Thesis draft compiles at \textbf{89 pages}: all chapters written, 4 figures, 26 tables, 81 metadata-verified references, all numbers auto-generated from the pipeline.
\end{block}
\end{column}
\end{columns}
\vspace{0.2cm}
...
Thesis draft & outline & \textbf{89 pp., compiles clean, submission package ready} \\
\bottomrule
\end{tabular}
\end{frame}
...
\small
\begin{itemize}
  \item \textbf{89 pages}, compiles clean: 0 undefined references, 4 figures, 26 tables.
