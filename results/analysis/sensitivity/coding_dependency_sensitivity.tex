...
\caption[Coding dependence sensitivity checks]{Coding dependence sensitivity checks for the final 60 pair result. These checks do not replace inter rater reliability. They show whether the substantive count depends on the softest coding dimension.}
