...
If the sheet must be regenerated, use the project-local sheet builder against
the restricted raw-output archive. Do not regenerate it from the public summary
tables alone.
