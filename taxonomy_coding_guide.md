...
Use for consumer-app and wrapper outputs. This is a formal observable coding variable after the 29 May supervision meeting. It captures visible access-channel affordances that are not part of the plain text answer and therefore cannot be represented by the API response alone.
