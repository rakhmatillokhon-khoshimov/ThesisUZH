...
CHANNELS = {
    "openai_gpt-4o": [
        ("r1", ROOT / "data/private/20260605/openai_api_scaleup_60/responses", "{pid}_r1.json"),
        ("r2", ROOT / "data/private/20260609/reps/openai_api/responses", "{pid}_r2.json"),
        ("r3", ROOT / "data/private/20260609/reps/openai_api/responses", "{pid}_r3.json"),
    ],
    "claude_sonnet-4": [
        ("r1", ROOT / "data/private/20260608/claude_api_scaleup_60/responses", "{pid}_r1.json"),
        ("r2", ROOT / "data/private/20260609/reps/claude_api_r2/responses", "{pid}_r1.json"),
        ("r3", ROOT / "data/private/20260609/reps/claude_api_r3/responses", "{pid}_r1.json"),
    ],
...
def main():
    ...
    # tex
    tex = ["% Script-produced by analyze_repetition_stability.py",
