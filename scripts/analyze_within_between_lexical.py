...
Outputs: results/analysis/lexical_within_between/
...
R1_DIR = BASE / "data/private/20260605/openai_api_scaleup_60/responses"
REPS_DIR = BASE / "data/private/20260609/reps/openai_api/responses"
APP_LOG = BASE / "data/private/20260608/chatgpt_app_scaleup_60_cleaned/chatgpt_app_log_private.csv"
PAIRWISE = BASE / "results/analysis/pairwise_results.csv"
OUT_DIR = BASE / "results/analysis/lexical_within_between"
...
def main() -> None:
    ...
    reviewed = BASE / "results/analysis/scaleup_human_reviewed_coding_sheet.csv"
    substantive = {}
    ...
    tex = f"""% Script-produced by analyze_within_between_lexical.py
