...
def main() -> int:
    ...
    parser.add_argument("--prompt-bank", type=Path, default=ROOT / "prompt_bank_60.csv")
    parser.add_argument("--api-log", type=Path, default=ROOT / "pilot_outputs" / "20260605" / "openai_api_scaleup_60" / "api_log_private.csv")
    parser.add_argument("--app-log", type=Path, default=ROOT / "pilot_outputs" / "20260608" / "chatgpt_app_scaleup_60_cleaned" / "chatgpt_app_log_private.csv")
