...
\caption{Cross-channel refusal-status matrix. Claude and Gemini are API-only robustness baselines; only OpenAI API versus ChatGPT app is a channel comparison.}\\
\toprule
